...
from typing import Literal, Optional, Callable, OrderedDict, Tuple
...
class CriticBuffer:
    ...
    def return_data(self) -> dict[str, list[int|str]]: 
        '''Returns collected data in buffer'''
        return {
